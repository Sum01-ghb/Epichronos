...
export default function Reports() {
    ...
    return (
      <div className="flex min-h-[calc(100vh-6rem)] flex-col items-center justify-center gap-6 text-center select-none relative z-10 p-6 bg-linear-to-br from-slate-50 via-blue-50/80 to-teal-50/80">
        ...
        <button
          ...
          className="group relative mt-6 inline-flex items-center justify-center gap-2 overflow-hidden rounded-2xl bg-linear-to-r from-sky-500 via-blue-500 to-teal-500 p-0.5 shadow-xl shadow-sky-500/20 transition-all hover:scale-[1.02] hover:shadow-sky-500/40 focus:outline-none">
  ...
  const effectivePatient = {
    ...
    age: patientData.age ? Number(patientData.age) : fallbackPatient.age,
